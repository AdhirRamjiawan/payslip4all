...
public interface IWalletTopUpService
{
    ...
    Task ProcessAuthoritativeCallbackAsync(string providerKey, IReadOnlyDictionary<string, string> payload, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<SiteAdministratorPaymentReviewDto>> GetAdminReviewAsync(SiteAdministratorPaymentReviewQueryDto query, CancellationToken cancellationToken = default);
}
